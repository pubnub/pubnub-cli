...
var Client = function (options) {
    ...
    self.init = function (input, holla) {
        ...
        self.request('post', ['api', 'me'], {
            ...
            if (body && body.error) {
                ...
                self.fetch_account(self.session, holla);
            }
    ...
    self.fetch_account = function (session, holla) {

      self.request('get', ['api', 'accounts'], {
        form: {
        ...
        if (body && body.error) {
          ...
          self.session = body.result;
          holla(null, { session: session, accounts: body.result });
        }
      });
    };
