...
var _class = function () {
  ...
  _createClass(_class, [{
      ...
      this.abstractedValidator(inputParams).then(function (fields) {
        _this.networking.createLoginToken({ email: fields.email, password: fields.password }, function (err, serverResponse) {
          ...
          if (_this.interactive) {
            _this._createSessionFile({ userId: userId, sessionToken: sessionToken }).then(function () {
              _this.logger.info('Login Succesful, token: ' + sessionToken + ' saved to home directory');
            });
          }
        });
      }).catch(function (err) {
    ...
    value: function _createSessionFile(_ref3) {
      var _this5 = this;
      ...
      return this._deleteSessonFile().then(function () {
        return new Promise(function (resolve) {
          _fs2.default.writeFile(_this5.sessionStorage, JSON.stringify({ sessionToken: sessionToken, userId: userId }), function (err) {
